        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "f_k_password_reset_tokens_system_users_user_id",
                        column: x => x.user_id,
            ...
            migrationBuilder.CreateIndex(
                name: "i_x_password_reset_tokens_code_hash",
                table: "password_reset_tokens",
                column: "code_hash");

            migrationBuilder.CreateIndex(
                name: "i_x_password_reset_tokens_expires_at",
                table: "password_reset_tokens",
                column: "expires_at");
            ...
            migrationBuilder.CreateIndex(
                name: "i_x_password_reset_tokens_user_id_is_used_expires_at",
                table: "password_reset_tokens",
